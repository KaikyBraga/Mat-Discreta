...
with open("styles.css") as f:
    ...
    # Criaçaõ de máscaras circulares
    ...
    # Margens transparentes às imagens para criar espaço entre elas
    kaiky = ImageOps.expand(kaiky, border=30, fill=None)
    samuel = ImageOps.expand(samuel, border=30, fill=None)

    # Imagens redondas lado a lado com espaçamento e nomes abaixo delas
